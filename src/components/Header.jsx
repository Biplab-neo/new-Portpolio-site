...
export default function Header() {
    return (
        <div className="w-11/12 pt-24 md:pt-32 text-center mx-auto flex flex-col items-center justify-center gap-4">
            <img src="./assets/profile-img.png" alt="" className="rounded-full w-[150px] md:w-[200px] h-[150px] md:h-[200px] object-cover object-top" />
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
                ...
                <a href="public/assets/current-cv_compressed.pdf" download
