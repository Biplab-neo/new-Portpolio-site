export default function Work() {
    ...
    const work = [
        {
            name: 'weather app using HTML ,CSS & javascript',
            icon: './assets/work-1.png',
            description: 'Web Design',
            link: 'https://bipsweather.netlify.app',
        },
        {
            name: 'A movie website using react with TMDB api',
            icon: './assets/work-2.png',
            description: 'mobile app',
            link: 'https://bipsneoflix.netlify.app',
        },
        {
            name: 'Designs made with HTML CSS & JAVASCRIPT',
    ...
    return (
        ...
        <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="grid grid-cols-auto my-10 gap-5 dark:text-black">
                {work.map((work) => (
                    <a href={work.link} key={work.name} className="aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group" style={{ backgroundImage: `url(${work.icon})` }}>
